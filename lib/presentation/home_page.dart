...
class _HomePageState extends State<HomePage > {
  ...
  static const List<Widget> pages =  [
    Text('All', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
    Text('in progress', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
    Text('performed', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
  ];
